...
class WebSearch_And_Crawl_Agent(ConversableAgent):
    def __init__(self, n_iters=2,**kwargs):
        """
        Initializes a WebSearch_And_Crawl_Agent instance.
        ...
        self.register_reply([Agent, None], reply_func=WebSearch_And_Crawl_Agent._reply_user, position=0)
